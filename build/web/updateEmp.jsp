...
<div class="container">
    ...
    try{
            ...
            Connection con=DriverManager.getConnection("jdbc:derby://localhost:1527/elebillsys ","ems","ems");
                PreparedStatement ps=con.prepareStatement("select * from emptbl where eid=?");
                ps.setString(1,eid);
 ...
 %>
         ...
         <form action="./empupdt" method="post"> 
               <div class="row">
                    <div class="col-sm-4">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <input type="text" class="form-control" id="nm" placeholder="Enter Employee Name" name="nm">
                    </div>
                </div>
                <div class="row">
                    <div class="col-sm-4">
                        <label for="Employee phone no">Employee Phone no:</label>
                    </div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <label for="customer type">Employee Type:</label>
                    </div>
                    <div class="col-sm-4"><%out.println(rs.getString(5));%>
                    </div>
                    <div class="col-sm-4">
                ...
                <div class="row">
                    <div class="col-sm-4">
                         <label for="customer plot no">Employee Plot no:</label></div>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <label for="customer city">Employee City:</label></div>
                ...
                <div class="row">
                  <div class="col-sm-4">
                    <label for="customer state">Employee State:</label>
                  </div>
