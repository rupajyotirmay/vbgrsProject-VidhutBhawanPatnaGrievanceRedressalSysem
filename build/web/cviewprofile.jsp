...
<div class="container">
	...
	<a class="dropdown-toggle"data-toggle="dropdown"href="#">Bill<span class="caret"></span></a>
		...
		<li><a href="BilPay.html">Payment</a></li>
	...
	<li><a href="index.html"><span class="glyphicon glyphicon-log-in"></span>Go Back</a></li>
	</ul>
	</div>
	</nav> 
</div>
  ...
  <table class="table table-bordered">
    ...
    try{
            ...
            PreparedStatement ps=con.prepareStatement("select * from consumertb where id=?");
         ps.setString(1,cid);
                    ...
                    while(rs.next())
            {
                %>
<tr>
    <td><%out.println(rs.getString(2));%></td><td><%out.println(rs.getString(3));%></td><td><%out.println(rs.getString(4));%></td>
    <td><%out.println(rs.getString(6));%></td><td><%out.println(rs.getString(7));%></td><td><%out.println(rs.getString(8));%></td>
    <td>Due &nbsp &nbsp &nbsp &nbsp <button onclick="window.location.href='BillPay.html'" style="width:auto;">Pay</button> </td>
</tr>         
                <%
            }
        }    
