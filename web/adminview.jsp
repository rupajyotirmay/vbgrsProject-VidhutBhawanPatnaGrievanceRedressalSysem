    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-sm-6">
                ...
                <a href="addemp.html"><button type="button" class="btn btn-success">Insert</button></a>
                <a href="empadminview.jsp"><button type="button" class="btn btn-info">View All</button></a>
                <a href="updateEmp.html"><button type="button" class="btn btn-warning">Update</button></a>
                <a href="updateEmp.html"><button type="button" class="btn btn-danger">Delete</button></a>
            </a>
            </div>
            <div class="col-sm-6">
                ...
                <a href="conUPDT.html"><button type="button" class="btn btn-warning">Update</button></a>
                <a href="conUPDT.html"><button type="button" class="btn btn-danger">Delete</button></a>
